...
import search from '@salesforce/apex/GroupLookupController.search';
import getRecentlyViewed from '@salesforce/apex/GroupLookupController.getRecentlyViewed';

export default class GroupLookup extends LightningElement {
